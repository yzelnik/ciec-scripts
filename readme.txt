...
You should open each of the three script files separately, and run it in several steps, by clicking each section (shown in yellow) and using Ctrl+Enter to run each section consecutively.

The other Matlab files in the folder are used by the 3 main script files.
